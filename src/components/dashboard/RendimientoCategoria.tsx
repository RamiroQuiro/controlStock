...
const RendimientoCategoria: React.FC<{ userId: string; empresaId: string }> = ({
  userId,
  empresaId,
}) => {
      ...
      <div className="w-full flex flex-col items-start justify-normal">
        ...
        <div className="flex flex-wrap w-full">
          {[1, 2, 3].map(
            (
              _,
              index // Mostramos 3 skeletons
            ) => (
              <div
                key={index}
                className="flex items-center group animate-pulse hover:bg-white duration-300 hover:shadow-sm bg-primary-bg-componentes w-full  border p-2 rounded-lg transition-all"
              >
    ...
    <div className="w-full">
      ...
      <div className="flex flex-wrap gap-3 w-full items-center">
        {datosRendimiento.categorias.map((categoria, index) => (
          <div
            key={index}
            className="flex items-center group hover:bg-white duration-300 hover:shadow-sm bg-primary-bg-componentes w-full  border p-2 rounded-lg transition-all"
          >
            <div className="relative w-16 h-16 mr-4">
              <svg
                className="w-16 h-16 transform -rotate-90"
