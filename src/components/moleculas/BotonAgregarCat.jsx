      ...
      {mostrarModalAgregar && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="relative bg-white rounded-lg shadow-lg p-6 w-full max-w-lg">
            ...
            <FormularioNuevaCategoria empresaId={empresaId} />
          </div>
        </div>
      )}
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-primary-texto text-white rounded-lg hover:bg-primary-100 transition"
      >
        <PlusCircle />
      </button>
    </div>
