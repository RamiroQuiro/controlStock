...
<div
  class="bg-white rounded-lg py-1 px-2 flex items-center shadow-md hover:-translate-y-0.5 hover:shadow-lg duration-200 cursor-pointer justify-between w-full"
>
  <div class="min-w-[75%] flex items-center justify-start gap-2 capitalize">
    ...
    <div class="flex flex-col items-start justify-normal">
      ...
      <h3
        class="text- font-semibold text-primary-textoTitle capitalize tracking-tight"
      >
        {prod.descripcion}
      </h3>
      {/* <!-- detalles --> */}
  ...
  <div class="text-end">
    <h3
      class="text-lg font-semibold text-primary-textoTitle capitalize tracking-tight"
    >
