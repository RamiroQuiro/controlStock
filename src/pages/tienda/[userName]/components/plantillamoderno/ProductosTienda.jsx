  ...
  return (
    <div className=" flex w-full items-start justify-normal gap-2  bg-white  flex-wrap">
      {data?.productos?.map((product) => (
        <div
          key={product.id}
          className="group w-1/4 h-96 cursor-pointer bg-white rounded-md border border-primary-texto/30 p-4 shadow-sm hover:shadow-md transition-all duration-300 transform flex flex-col"
        >
