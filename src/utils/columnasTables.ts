...
const columnasResultadosImportacion = [
  { label: "Fila", id: 1, selector: (_row: { [key: string]: any }, index: number = 0) => index + 1 },
  { label: "Nombre", id: 2, selector: (row: any) => row.nombre || row.nombreProducto },
  { label: "Estado", id: 3, selector: 'estado' },
  { label: "Mensaje", id: 4, selector: 'mensaje' },
];
...
export const columnasVentasTodas = [
  ...
  { label: 'Cliente', id: 3, selector: 'nombreCliente' },
  { label: 'dni Cliente', id: 4, selector: 'dniCliente' },
